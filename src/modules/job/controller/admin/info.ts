...
@CoolController({
  ...
  pageQueryOp: {
    ...
    select: [
      ...
      'e.phoneNumber AS customerPhone',
      'e.secNumber AS customerSecPhone',
      'e.emailAddress AS customerEmail',
      'e.address AS customerAddress',
      'e.abn AS customerAbn',
      'e.workLocation AS customerWorkLocation',
      'e.customerAt AS customerAt',
      'e.businessName AS customerBusinessName',
      'e.businessContactNumber AS customerBusinessPhone',
      'e.role AS customerRole',
      'e.licenceState AS customerLicenceState',
      'e.licenceGivenName AS customerLicenceGivenName',
      'e.licenceSurname AS customerLicenceSurname',
      'e.licenceAddress AS customerLicenceAddress',
      // Keep firstName/surname aliases too for backward-compat with existing UI
      'e.firstName',
      'e.surname',
    ],
    // 多表关联，请求筛选字段与表字段不一致的情况
