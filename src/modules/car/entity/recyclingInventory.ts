...
/**
 * Recycling Inventory — individual parts from recycling vehicles.
 *
 * Mirrors parts_inventory structure exactly.
 ...
 */
@EntityModel('recycling_inventory')
export class RecyclingInventoryEntity extends BaseEntity {
  @Index()
